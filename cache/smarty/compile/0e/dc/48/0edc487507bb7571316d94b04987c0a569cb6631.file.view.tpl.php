<?php /* Smarty version Smarty-3.1.19, created on 2017-02-06 03:38:30
         compiled from "C:\Apache24\htdocs\admin\themes\default\template\controllers\dashboard\helpers\view\view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6333007795897efb694a333-29168242%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0edc487507bb7571316d94b04987c0a569cb6631' => 
    array (
      0 => 'C:\\Apache24\\htdocs\\admin\\themes\\default\\template\\controllers\\dashboard\\helpers\\view\\view.tpl',
      1 => 1482178620,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6333007795897efb694a333-29168242',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5897efb69cf055_82582325',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5897efb69cf055_82582325')) {function content_5897efb69cf055_82582325($_smarty_tpl) {?>
<script>
...
<?php }?>
			<div id="calendar" class="panel">
				<form action="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['action']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
...
">
					...
					<input type="hidden" name="datepickerFrom" id="datepickerFrom" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['date_from']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" class="form-control">
					<input type="hidden" name="datepickerTo" id="datepickerTo" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['date_to']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" class="form-control">
					...
					<div class="form-group pull-right">
						<button id="datepickerExpand" class="btn btn-default" type="button">
							...
							<span class="hidden-xs">
								...
								<strong class="text-info" id="datepicker-from-info"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['date_from']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
</strong>
								<?php echo smartyTranslate(array('s'=>'To'),$_smarty_tpl);?>

								<strong class="text-info" id="datepicker-to-info"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['date_to']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
</strong>
