<?php /* Smarty version Smarty-3.1.19, created on 2017-02-06 03:38:35
         compiled from "C:\Apache24\htdocs\admin\themes\default\template\page_header_toolbar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2995375725897efbb7bcdb5-62288791%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1db3a781d072ec4bfd550143b2041d13f0ba7ab8' => 
    array (
      0 => 'C:\\Apache24\\htdocs\\admin\\themes\\default\\template\\page_header_toolbar.tpl',
      1 => 1482178620,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2995375725897efbb7bcdb5-62288791',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5897efbb860ed6_62487140',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5897efbb860ed6_62487140')) {function content_5897efbb860ed6_62487140($_smarty_tpl) {?>
...
<?php }?>" class="toolbar_btn <?php if (isset($_smarty_tpl->tpl_vars['btn']->value['target'])&&$_smarty_tpl->tpl_vars['btn']->value['target']) {?> _blank<?php }?> pointer"<?php if (isset($_smarty_tpl->tpl_vars['btn']->value['href'])) {?> href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btn']->value['href'], ENT_QUOTES, 'ISO-8859-1', true);?>
"<?php }?> title="<?php if (isset($_smarty_tpl->tpl_vars['btn']->value['help'])) {?><?php echo $_smarty_tpl->tpl_vars['btn']->value['help'];?>
<?php } else { ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btn']->value['desc'], ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php }?>"></i>
							<div<?php if (isset($_smarty_tpl->tpl_vars['btn']->value['force_desc'])&&$_smarty_tpl->tpl_vars['btn']->value['force_desc']==true) {?> class="locked"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btn']->value['desc'], ENT_QUOTES, 'ISO-8859-1', true);?>
</div>
						</a>
					</li>
					<?php }?>
