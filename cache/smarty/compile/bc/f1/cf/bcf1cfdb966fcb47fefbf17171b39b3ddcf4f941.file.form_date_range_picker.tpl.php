<?php /* Smarty version Smarty-3.1.19, created on 2017-02-06 03:38:33
         compiled from "C:\Apache24\htdocs\admin\themes\default\template\form_date_range_picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:13700838075897efb99faa91-54922551%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bcf1cfdb966fcb47fefbf17171b39b3ddcf4f941' => 
    array (
      0 => 'C:\\Apache24\\htdocs\\admin\\themes\\default\\template\\form_date_range_picker.tpl',
      1 => 1482178620,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '13700838075897efb99faa91-54922551',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5897efb9a12193_99475413',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5897efb9a12193_99475413')) {function content_5897efb9a12193_99475413($_smarty_tpl) {?><div id="calendar" class="panel">
...
<?php }?></label>
									<input type="text" name="datepickerFrom" id="datepickerFrom" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['datepickerFrom']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
...
<?php } else { ?><?php echo smartyTranslate(array('s'=>'From:'),$_smarty_tpl);?>
<?php }?></label>
									<input type="text" name="datepickerTo" id="datepickerTo" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['datepickerTo']->value, ENT_QUOTES, 'ISO-8859-1', true);?>
" class="datepicker  form-control">
								</div>
							</div>
						</div>
